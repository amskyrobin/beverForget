...
module.exports = {"drinkingEstablishment":[{"name":"Footlights","type":"bar","id":0,"drinks":[{"id":1,"name":"dark and stormy","price":6},{"id":2,"name":"gin and tonic","price":8},{"id":3,"name":"moscow mule","price":7.2}]},{"name":"Chanter","type":"bar","id":1,"drinks":[{"id":4,"name":"margarita","price":5},{"id":5,"name":"tequila sunrise","price":5.2},{"id":6,"name":"brewdog","price":5.9}]}]}
...
var _mockJSON = __webpack_require__(7);

var _mockJSON2 = _interopRequireDefault(_mockJSON);

var _drinkingEstablishment = __webpack_require__(29);

var _drinkingEstablishment2 = _interopRequireDefault(_drinkingEstablishment);
...
var Container = function (_React$Component) {
  ...
  _createClass(Container, [{
    ...
    value: function render() {
      return _react2.default.createElement(_drinkingEstablishment2.default, null);
    }
  }]);
...
var DrinkingEstablishment = function (_React$Component) {
  _inherits(DrinkingEstablishment, _React$Component);
  ...
  function DrinkingEstablishment(props) {
    ...
    _this.getDrinksListTwo = _this.getDrinksListTwo.bind(_this);
    return _this;
  }
  ...
  _createClass(DrinkingEstablishment, [{
    ...
    key: "getDrinksList",
    value: function getDrinksList() {
      var _this2 = this;

      var drinksString = _mockJSON2.default.drinkingEstablishment;
      var drinksListArray = [];
      for (var i = 0; i < drinksString.length; i++) {
        ...
        this.setState({ drinks: drinksListArray }, function () {
          console.log("state in setState:", _this2.state);
        });
      }
    }
  }, {
    key: "getDrinksListTwo",
    value: function getDrinksListTwo(id) {
      var _this3 = this;

      var drinksString = _mockJSON2.default.drinkingEstablishment[id].drinks;
      console.log(drinksString);
      var drinksListArrayTwo = [];
      for (var i = 0; i < drinksString.length; i++) {
      ...
      this.setState({ drinks: drinksListArrayTwo }, function () {
        console.log("state in setState:", _this3.state);
      });
    }
  }, {
    ...
    value: function handleDrinkListClick(event, item) {
      var id = item.id;
      console.log(id);
            ...
            _react2.default.createElement(
              "p",
              {
                ...
                onClick: function onClick() {
                  return _this4.handleDrinkListClick(event, item);
                },
                key: index,
                value: item.id
              },
